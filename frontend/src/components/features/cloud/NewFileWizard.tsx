...
const ALL_MODULES: ModuleOption[] = [
  ...
  { code: "0557", name: "Desarrollo web en entorno cliente", groupName: "2º Sistemas de Telecomunicaciones e Informáticos" },
  { code: "0558", name: "Desarrollo web en entorno servidor", groupName: "2º Sistemas de Telecomunicaciones e Informáticos" },
  ...
  { code: "0567", name: "Desarrollo de aplicaciones con entorno web", groupName: "2º Desarrollo de Aplicaciones Multiplataforma" },
  { code: "0568", name: "Desarrollo de aplicaciones con entorno móvil", groupName: "2º Desarrollo de Aplicaciones Multiplataforma" },
  ...
  { code: "0573", name: "Desarrollo web en entorno cliente", groupName: "1º Desarrollo de Aplicaciones Web" },
  { code: "0574", name: "Desarrollo web en entorno servidor", groupName: "1º Desarrollo de Aplicaciones Web" },
  ...
  { code: "0575", name: "Desarrollo web en entorno cliente", groupName: "2º Desarrollo de Aplicaciones Web" },
  { code: "0576", name: "Desarrollo web en entorno servidor", groupName: "2º Desarrollo de Aplicaciones Web" },
