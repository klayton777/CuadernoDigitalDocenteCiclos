...
export function EvaluacionRecursosTab() {
  ...
  return (
      <div className="flex items-start gap-3 p-4 rounded-xl bg-accent/5 border border-accent/20 mb-6">
        ...
        <div>
          <p className="text-sm font-semibold text-foreground">Evaluación y Recursos — RD 659/2023 (Art. 136)</p>
          <p className="text-sm text-muted mt-1">La evaluación debe ser continua, formativa e integradora.</p>
        </div>
      </div>
